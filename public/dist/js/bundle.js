...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createCicaGa", () => { return createCicaGa; });
/* harmony import */ let _polyfills__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./polyfills */ "./src/js/polyfills.js");

let polyfills = Object(_polyfills__WEBPACK_IMPORTED_MODULE_0__.createPolyfills)();
  ...
  function detailsElementHandler(element) {
                        polyfills.addEventListener(
                            ...
                            function() {
                                ...
                                if (open === null) {
        let detailsTagText = element.querySelector('.govuk-details__summary-text').innerText;
                                    send({
                                        action: 'open',
    ...
    polyfills.addEventListener(document, 'scroll', () => {
    ...
    let trackableElements = document.querySelectorAll('[data-module], .ga-event'); // GOVUK modules, and custom events tracking.
        ...
        return;
                            ...
                            let dataModuleId = element.getAttribute('data-module');
...
"use strict";
                ...
                __webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createPolyfills", () => { return createPolyfills; });
function createPolyfills() {
      ...
      callback.call(scope, i, array[i]);
                    ...
                    function hasClass(elem, classToCheck) {
                        return (
                            ' '.concat(elem.className, ' ').indexOf(' '.concat(classToCheck, ' ')) >
                            -1
                        );
                    }
...
"use strict";
                ...
                __webpack_require__.r(__webpack_exports__);
/* harmony import */ let _ga__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ga */ "./src/js/ga.js");


(function () {
  let cicaGa = Object(_ga__WEBPACK_IMPORTED_MODULE_0__.createCicaGa)();
