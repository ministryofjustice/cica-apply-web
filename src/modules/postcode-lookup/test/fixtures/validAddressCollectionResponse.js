const addressSearchThreeAddressesFoundResponse = {
    header: {
        uri: 'https://api.os.uk/search/places/v1/postcode?postcode=CF645UL',
        query: 'postcode=CF645UL',
        offset: 0,
        totalresults: 3,
        format: 'JSON',
        dataset: 'DPA',
    ...
    results: [
        {
            DPA: {
                UPRN: '64010696',
                UDPRN: '4511806',
                ADDRESS: '2, FORT ROAD, LARNOG, PENARTH, CF64 5UL',
                BUILDING_NUMBER: '2',
                THOROUGHFARE_NAME: 'FORT ROAD',
                DEPENDENT_LOCALITY: 'LARNOG',
                POST_TOWN: 'PENARTH',
                POSTCODE: 'CF64 5UL',
                RPC: '2',
                ...
                LOCAL_CUSTODIAN_CODE_DESCRIPTION: 'VALE OF GLAMORGAN',
                COUNTRY_CODE: 'W',
        ...
        },
        {
            DPA: {
                UPRN: '64010691',
                UDPRN: '4511798',
                ADDRESS: 'BARUCH, FORT ROAD, LARNOG, PENARTH, CF64 5UL',
        ...
        },
        {
            DPA: {
                UPRN: '64012070',
                UDPRN: '4511799',
                ADDRESS: 'CHURCH HOUSE, FORT ROAD, LARNOG, PENARTH, CF64 5UL',
