...
import createLandingPageEngagementTracker from '../modules/ga/landing-page-engagement';
...
(() => {
    ...
    if (cookiePreference.get('analytics').value === '1') {
        ...
        cicaGa.init();
        const landingPageEngagementTracker = createLandingPageEngagementTracker(window);
