...
[![GitHub repo npm version](https://img.shields.io/badge/npm_version->=11.12.1-blue)](https://github.com/CriminalInjuriesCompensationAuthority/cica-web/blob/master/package.json#L5)
[![GitHub repo node version](https://img.shields.io/badge/node_version->=24.18.1-blue)](https://github.com/CriminalInjuriesCompensationAuthority/cica-web/blob/master/package.json#L6)
...
-   You have Node `">=24.18.1"` installed globally.
