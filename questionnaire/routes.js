        ...
        const questionnaireService = createQuestionnaireService({
            ...
            userData: {
                personalisation: {
                    ...
                    'decision-reason':
                        'I assess every claim on its own merits and reach a decision based on the available.</p><p class="govuk-body">By way of explanation, the amount of compensation that can be awarded and the rules that I must apply are set out in the Criminal Injuries Compensation Scheme 2012 (the Scheme). The Scheme rules are approved by parliament. </p><p class="govuk-body">Paragraph 25 of the Scheme tells us that an award may be withheld or reduced where the conduct of the applicant before, during or after the incident makes it inappropriate to make an award or a full award.</p><p class="govuk-body">Within their report the police told us that a counter allegation was made by the accused against you and you received a police warning for this. They told us this was minor incident and both parties admitted to assaulting each other. Due to the details of the incident provided to us my the police it would be inappropriate to make a full or reduced award under paragraph 25 of the Scheme.</p><p class="govuk-body">When assessing an application for compensation we must also consider paragraph 87 which states an application must be sent by the applicant so that it is received as soon as reasonably practicable after the incident giving rise to the criminal injury to which it relates, and in any event within two years after the date of that incident.</p><p class="govuk-body">The police report confirms that the incident occurred on 29 June 2021 and we received your application on 02 September 2023. As your application is being rejected under other paragraphs within the Scheme I am deciding to not extend the time limit to apply in your case. So I must also refuse this application under paragraph 87 of the Scheme.</p><p class="govuk-body">I appreciate this will be disappointing news and not the decision you were hoping for, however this is in no way intended to diminish my recognition of the suffering you experienced.',
                    'decision-paragraphs':
                        '[case handler/decision maker enters relevant Scheme paragraphs] [Under paragraph 25 of the Scheme "An award may be withheld or reduced where the conduct of the applicant before, during or after the incident giving rise to the criminal injury makes it inappropriate to make an award or a full award." </p><p class="govuk-body">Under paragraph 87 of the Scheme "Subject to paragraph 88, an application must be sent by the applicant so that it is received by the Authority as soon as reasonably practicable after the incident giving rise to the criminal injury to which it relates, and in any event within two years after the date of that incident."]',
